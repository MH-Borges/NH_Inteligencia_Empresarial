...
$senha_crip = md5('Douglas312@');
$data = date('Y/m/d H:i:s');

if(@count($dados) == 0){
    $res = $pdo->query("INSERT into usuarios (nome_Completo, nivel, email, senha, senha_Crip, data_Registro) values ('Administrador', 'adm', '$email_adm', 'Douglas312@', '$senha_crip', '$data' )");
}
